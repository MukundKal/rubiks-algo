 ...
 * - We use an 'object' (Singleton) here for simplicity, but in a larger app,
 * this would be a class injected via Dependency Injection (Hilt/Koin).
 */
object RubiksRepository {
    ...
    val steps = listOf(
        ...
        RubiksStep(5, "Move to top Yellow Cross", "F R U R' U' F'"),
        RubiksStep(6, "Swap front/left edges", "R U R' U R U2 R' U", "Cross edges match centers"),
        RubiksStep(7, "Position yellow corners", "U R U' L' U R' U' L", "Repeat x N times"),
        RubiksStep(8, "Orient yellow corners", "R' D' R D", "Repeat until solved")
    )
